...
def simulate_ctc(dyn, controller, trajectory, duration, dt):
    ...
    return {'times': times, 'q_hist': q_hist, 'e_hist': e_hist,
            'tau_hist': tau_hist, 'pos_ref': pos_ref, 'pos_hist': pos_hist,
            'rmse': rmse}
...
if __name__ == '__main__':
    ...
    res_c = simulate_ctc(dyn, ctc, circle, duration=8.0, dt=dt)

    fig8 = Figure8Trajectory(period=5.0)
    res_f8 = simulate_ctc(dyn, ctc, fig8, duration=10.0, dt=dt)
